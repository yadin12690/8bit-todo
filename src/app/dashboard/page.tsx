        ...
        <div className='flex justify-end flex-col w-full h-full py-20 px-20'>
            ...
            <div className="card-container flex justify-end">
                ...
                <div className="content-container flex justify-center items-center flex-col relative gap-2 top-40 right-[26rem] h-fit">
                    <div className={`${press_start_2P.className} pixel-text-area text-xs lvl2 text-gray-500`}><input ref={userTask}
                        onChange={addNewTask}
                        placeholder="Enter task content..." /></div>
                    <button className={`${press_start_2P.className} addNewTaskBtn text-black`} onClick={() => console.log(userTask.current?.value)
                    }>Add new task</button>
                </div>
            </div>
        </div>
